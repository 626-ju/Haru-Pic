  ...
  return (
    <div className="flex justify-center items-center h-[90vh]">
      <div className=" flex flex-col xl:flex-row gap-10 xl:gap-0 xl:justify-between xl:items-end bg-background mx-auto  w-78 md:w-91 xl:w-[1188px]">
        <img className="block xl:order-1 w-78 h-[210px] md:w-91 md:h-60 xl:w-186 xl:h-97 object-cover object-bottom rounded-2xl shadow-lg" src={landingPic} alt='사용 설명 이미지' />
